...
describe Video do
  describe 'validations' do
    ...
    it 'is invalid if total inventory is a negative integer' do
      @video.total_inventory = -4
    ...
    it 'is invalid if available inventory is a negative integer' do
      @video.available_inventory = -4
